...
bool Setup()
{
	...
	{
		USES_CONVERSION;
		::MessageBox(0, A2W((char*)errorBuffer->GetBufferPointer()), 0, 0);
		d3d::Release<ID3DXBuffer*>(errorBuffer);
	}

	if(FAILED(hr))
	{
		::MessageBox(0, TEXT("D3DXCompileShaderFromFile() - FAILED"), 0, 0);
		return false;
	}
	...
	D3DXCreateTextureFromFile(Device, TEXT("crate.bmp"), &BaseTex);
	D3DXCreateTextureFromFile(Device, TEXT("spotlight.bmp"), &SpotLightTex);
	D3DXCreateTextureFromFile(Device, TEXT("text.bmp"), &StringTex);
